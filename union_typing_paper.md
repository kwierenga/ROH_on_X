...
- **The mother–son arm has no real-data anchor.** A systematic search found no published offspring genome from a confirmed mother–son union (clinical, forensic, biobank, or ancient DNA); the FD and SS arms have incidental/ground-truth female-X observations (Sund 2013; Dash 2023; FSI:GSS 2015) but MS does not. The ½ expected F_X for MS, and the FD-vs-MS results, are therefore validated only in simulation and theory.
...
20. Yengo L, Wray NR, Visscher PM. Extreme inbreeding in a European ancestry sample from the contemporary UK population. *Nat Commun* 2019;10:3719. doi:10.1038/s41467-019-11724-6 (PMID 31481654). [Used F_roh(X) ≈ ½ vs ¼ to separate parent–offspring from full-sib among extreme-inbreeding UK Biobank individuals; verify exact X analysis against full text before final citation.]
21. Dash HR, et al. Genetic analysis of father–daughter incest using multifaceted STR markers and study of inheritance pattern of alleles. *Curr Forensic Sci* 2023. doi:10.2174/2666484401666210809114452. [verify authors/volume/pages]
